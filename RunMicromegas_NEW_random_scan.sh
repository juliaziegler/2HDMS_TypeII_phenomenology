...
F=results.csv
FOLDER=find_BP_random-test
########################################################
# main working directory:
MAIN_DIR=~/Applications/do_scan
# this directory is for all outputs, directory should exist already:
OUT=$MAIN_DIR/output
...
do
 ...
 line1=$HB_DIR,$HS_DIR,$SPHENO_OUT_DIR/SPheno.spc.complexZ2b,$OUTPUT/$F,$i

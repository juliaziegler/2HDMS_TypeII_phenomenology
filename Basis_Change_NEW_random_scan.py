...
def random_bp_generation():
    ...
    mAS = 1000 #random_number_gen_w_bounds(np.array([50, 1000]))
    mh1 = 400 #random_number_gen_w_bounds(np.array([700, 1500]))
    mh2 = 125.09 #random_number_gen_w_bounds(np.array([125.09, 125.09]))
    mh3 = random_number_gen_w_bounds(np.array([30, 1000])) #np.array([2*mAS, 1200])
    mA = 650 #random_number_gen_w_bounds(np.array([680, 750])) #np.array([mh3-50, mh3+50])
    mHm = 650 #random_number_gen_w_bounds(np.array([mh1-100, mh1+100])) #np.array([mh3-50, mh3+50])
    v = 246.220569 #random_number_gen_w_bounds(np.array([246.220569, 246.220569]))
    tanbeta = 2 #random_number_gen_w_bounds(np.array([1, 10])) #2.130902
    ...
    mutil2 = 162500 #random_number_gen_w_bounds(np.array([(mA-100)**2, (mA+100)**2]))
    #mSp2 = random_number_gen_w_bounds(np.array([-80000, 600000]))
    #alignm = random_number_gen_w_bounds(np.array([0.998, 1]))
    l1ml3pp =  random_number_gen_w_bounds(np.array([-10, 10])) #-0.427248
    l1m24p =  random_number_gen_w_bounds(np.array([-10, 10])) #0.077784
    l2m25p =  random_number_gen_w_bounds(np.array([-10, 10])) #0.036923
    #lh1 = random_number_gen_w_bounds(np.array([-3, 3]))
    #lh2 = random_number_gen_w_bounds(np.array([-3, 3]))
    #a1 = random_number_gen_w_bounds(np.array([-np.pi/2, np.pi/2])) #-0.421942
    a2 = random_number_gen_w_bounds(np.array([-np.pi/2, np.pi/2])) #-0.014232
    a3 = 0 #random_number_gen_w_bounds(np.array([-np.pi/2, np.pi/2])) #-0.007314
    cosbeta_a1 = 0 #random_number_gen_w_bounds(np.array([-0.1, 0.1])) # cos(beta-a1)
    ...
    vS = random_number_gen_w_bounds(np.array([1, 1000])) #587.168152
